                            ...
                            <div class="d-flex gap-4">
                                <div class="d-flex flex-column gap-2 w-50">
                                    <div class="input_container input_contact">
                                        <input type="text" name="name" placeholder="{{ __('website/contact.name') }}" required />
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-2 w-50 mb-4">
                                    <div class="input_container input_contact">
                                        <input type="email" name="email" placeholder="{{ __('website/contact.email') }}" required />
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column gap-2 mb-4">
                                <div class="input_container input_contact">
                                    <input type="text" name="subject" placeholder="{{ __('website/contact.subject') }}" required />
                                </div>
                            </div>
                            <div class="d-flex flex-column gap-2">
                                <div class="input_container input_contact">
                                    <textarea name="message" placeholder="{{ __('website/contact.message') }}" rows="5" required></textarea>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary mt-3">{{ __('website/contact.send_message') }}</button>
                        </form>
                    </div>
                </div>
