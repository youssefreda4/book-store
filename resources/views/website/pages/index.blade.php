            ...
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-1.jpg" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-2.png" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-3.jpg" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-4.jpg" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-5.jpg" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-6.jpg" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-7.png" alt="" />
                    </li>
                    <li class="splide__slide">
                        <img src="{{ asset('front-assets') }}/images/book-8.png" alt="" />
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="recommended_card d-flex gap-4 p-4">
                        <div class="recomended_card__image">
                            <img src="{{ asset('front-assets') }}/images/book-1.jpg" alt="" class="w-100 h-100" />
                        </div>
